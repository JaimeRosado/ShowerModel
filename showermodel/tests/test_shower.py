def test_shower():
    ...
    assert shower.atmosphere.P[100] == 49.69842905334434
    assert shower.track.t[200] == 254.50685251195043
    assert shower.profile.s[10] == 1.6504072224436146
    assert shower.cherenkov.N_ph[50] == 757147.620313149
